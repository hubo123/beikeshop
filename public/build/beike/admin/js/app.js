...
var tinymceInit = function tinymceInit() {
  ...
  tinymce.init({
    ...
    setup: function setup(ed) {
      var height = ed.getElement().dataset.tinymceHeight;
      // console.log(ed);
      // 修改 tinymce 的高度
      // if (height) {
